...
while playAgain=="1":
    ...
    guess10 = input("As Jabari is playing in the pool, Jabari's brother says he can hold his breath for 5 mins! Would this statement be accurate? Y for Yes| N for No: ")
    check_guess(guess10, "n")
    guess11 = input("How many people in Jabaris family are at the pool?")
    check_guess(guess11, "3")
    guess12 = input("Please type the set number for which family memebrs are at the pool. Set 1 = Jabari, Jabari's Dad, Jabari's cousin. Set 2 = Jabari, Jabari's Brother, Jabari's Father. Set 3 = Jabari, Jabari's Brother, Jabari's uncle.")
    check_guess(guess12, "2")
